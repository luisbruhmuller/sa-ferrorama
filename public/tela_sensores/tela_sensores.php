...
<body class="app-layout bg-light">
    <aside class="app-sidebar bg-dark text-white">
        ...
        <a href="../../public/tela_home/tela_geral_home.php" class="nav-link text-white rounded px-3 py-2">
...
<a href="../../public/Tela%20sensores/tela_sensores.php" class="nav-link text-white rounded px-3 py-2 bg-warning bg-opacity-25" aria-current="page">
    <i class="bi bi-cpu me-2"></i>Sensores IoT
</a>

<a href="../../public/Tela%20Usu%C3%A1rio/tela_usuarios.php" class="nav-link text-white rounded px-3 py-2">
